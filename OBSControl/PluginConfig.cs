...
internal class PluginConfig
{
    ...
    public virtual Vector3 ControlScreenPosition { get; set; } = new(-3f, 3.4f, 2f);
    public virtual Quaternion ControlScreenRotation { get; set; } = Quaternion.Euler(330f, 301f, 0f);
}